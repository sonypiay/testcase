...
{
	$getData = $fakultasClass->getAllData( $_REQUEST );
}
else
{
	$getData = $fakultasClass->getAllData();
}
?>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="uk-grid-small uk-child-width-auto" uk-grid>
						<div>
							<select class="uk-select" name="is_publish">
								...
								<option value="Publish" <?php if( isset( $_REQUEST['is_publish'] ) && $_REQUEST['is_publish'] == 'Publish' ) echo 'selected'; ?>>Ya</option>
								<option value="Not Publish" <?php if( isset( $_REQUEST['is_publish'] ) && $_REQUEST['is_publish'] == 'Not Publish' ) echo 'selected'; ?>>Tidak</option>
							</select>
						</div>
						<div>
